...
pub use crate::bindings::{
  ...
  sqlite3_module as module, sqlite3_stmt as stmt, sqlite3_uint64 as uint64, sqlite3_value as value,
  sqlite3_vtab as vtab, sqlite3_vtab_cursor as vtab_cursor, sqlite_int64 as int64,
...
mod aliased {
  ...
  pub use crate::bindings::{
    ...
    sqlite3_bind_int as bind_int, sqlite3_bind_int64 as bind_int64, sqlite3_bind_null as bind_null,
    ...
    sqlite3_create_function_v2 as create_function_v2, sqlite3_create_module_v2 as create_module_v2,
    ...
    sqlite3_randomness as randomness, sqlite3_reset as reset, sqlite3_result_blob as result_blob,
...
pub extern "C" fn sqlite_alloc(size: usize) -> *mut u8 {
  malloc(size)
}

pub extern "C" fn sqlite_free(ptr: *mut c_void) {
  free(ptr)
}
